...
# Determine database type and set appropriate engine
database_url = settings.DATABASE_URL

if database_url.startswith("sqlite"):
    # SQLite database - no special transformations needed for aiosqlite
    ...
    # PostgreSQL database - asyncpg transformations
